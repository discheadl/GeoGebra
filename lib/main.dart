      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            ListTile(leading: const Icon(Icons.save), title: const Text('Save'), onTap: () {}),
        ...
        children: [
          Positioned.fill(
            child: GestureDetector(
              ...
              child: Container(
                color: Colors.white,
                child: GraphWidget(equations: _equations, scale: _scale, offset: _offset),
              ),
            ),
          ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                       ...
                       Container(
                         ...
                         child: ListView(
                           ...
                           children: _equations.map((e) => ListTile(
                             dense: true,
                             leading: const CircleAvatar(backgroundColor: Color(0xFF6762A6), radius: 5),
                             title: Text("f(x) = $e"),
                             trailing: IconButton(
                     ...
                     Row(
                      children: [
                        const Icon(Icons.add, color: Color(0xFF6762A6)),
                        const SizedBox(width: 10),
                        Expanded(
                          child: TextField(
                            controller: _controller,
                            decoration: const InputDecoration(
                              hintText: 'Input... (ej: x^2)',
          ...
          if (_selectedIndex == 1)
            DraggableScrollableSheet(
              ...
              builder: (context, scrollController) {
                return ToolsMenu(controller: scrollController);
              },
            ),
          if (_selectedIndex == 2)
            DraggableScrollableSheet(
              ...
              maxChildSize: 0.9,
              builder: (context, scrollController) {
                return TableMenu(controller: scrollController);
              },
            ),
        ],
      ),
